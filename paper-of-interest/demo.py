...
img_path = '/Users/Matthew/SYDE675/Term Project/FSC147_384_V2/images_384_VarV2/7704.jpg'
...
parser.add_argument("-o", "--output-dir", type=str, default="/Users/Matthew/SYDE675/Term Project/output", help="/Path/to/output/image/file")
parser.add_argument("-m",  "--model_path", type=str, default="pretrainedModels/FamNet_Save1.pth", help="path to trained model")
